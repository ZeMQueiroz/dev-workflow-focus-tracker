              ...
              {isLoggedIn ? (
                ...
                <>
                  ...
                  <p className='max-w-3xl text-center text-[0.75rem] text-[var(--text-muted)] md:text-[0.8rem]'>
                    Sign in with GitHub or Google to start logging focus
                    sessions. No automatic tracking — only what you choose to
                    log.
                  </p>
                </>
              )}
              ...
              <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3'>
                ...
                <div className='flex flex-col gap-2 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface-soft)] p-4'>
                  ...
                  <p className='text-xs text-[var(--text-muted)]'>
                    ...
                    intention, and optional notes. No tickets or backlog
                    required.
                  </p>
                </div>
                ...
                <div className='flex flex-col gap-2 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface-soft)] p-4'>
                  ...
                  <p className='text-xs text-[var(--text-muted)]'>
                    Generate a structured Markdown recap of your week
                    that&apos;s ready to paste into Notion, Obsidian, status
                    emails, or client reports.
                  </p>
                </div>
              </div>
            </div>
