...
import { TodayLogsPanel } from "@/components/today-logs-panel";
              ...
              <div className='space-y-7'>
                ...
                <div className='space-y-3'>
                  ...
                  <p className='max-w-xl text-sm text-[var(--text-muted)] md:text-base'>
                    Focus Tracker turns your day into a clean timeline of what
                    you actually worked on — perfect for weekly reviews, 1:1s,
                ...
                <div className='grid gap-3 sm:grid-cols-2'>
                  <div className='flex gap-3 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface-soft)] p-3'>
                    ...
                    <div>
                      ...
                      <p className='mt-1 text-xs text-[var(--text-muted)]'>
                        One quick entry per block of work. No backlog grooming
                        or ticket hygiene required.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-3 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface-soft)] p-3'>
                    ...
                    <div>
                      ...
                      <p className='mt-1 text-xs text-[var(--text-muted)]'>
                        Week and project views show your actual focus — not just
                        a list of tickets.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-3 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface-soft)] p-3 sm:col-span-2'>
                    ...
                    <div>
                      ...
                      <p className='mt-1 text-xs text-[var(--text-muted)]'>
                        The Summary tab generates a Markdown report you can
                        paste directly into Obsidian or email — no formatting
                        needed.
                      </p>
                    </div>
                  </div>
